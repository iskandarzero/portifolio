...
export default function ProjectCard({project}:{project:Project}) {
  ...
  return (
    <div className="group group/item p-[2px] pt-[6px] bg-yel relative mx-[1vw]">
      <p className="ml-1">{project.name}</p>
      <Image className="group/edit group-hover:brightness-50" src={project.image} alt="test" height={290} width={290} unoptimized={true} />
